...
const Footer = () => {
  return (
    <footer className="footer">
      <div className="footer-container">
        <h2 className="footer-logo">MERN Auth</h2>
        <p className="footer-desc">
          A complete authentication system built with the MERN stack, featuring
          OTP verification, secure password reset, and email notifications.
        </p>
